...
namespace Bice.GrailWars.View
{
    ...
    {
        public Action<PlayerElement> action = delegate { };
        public Action<PlayerElement> restart = delegate { };
        ...
        private void Awake()
        {
            ...
            input.actions["Action"].started += ctx => Action();

            input.actions["Restart"].started += ctx => restart.Invoke(this);
        }
